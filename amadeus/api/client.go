...
// Client manages communication with the Amadeus API
...
// NewAPIClient creates a new API api. Requires a userAgent string describing your application.
...
func NewAPIClient(cfg *Configuration) *Client {
	...
	// API Services
	c.ShoppingAPI = (*APIService)(&c.common)
...
func NewGenericOpenAPIError(error string, body []byte, model interface{}) *GenericOpenAPIError {
...
func NewGenericOpenAPIErrorWithError(error string) *GenericOpenAPIError {
	return NewGenericOpenAPIError(error, nil, nil)
}

func NewGenericOpenAPIErrorWithErrorAndBody(error string, body []byte) *GenericOpenAPIError {
	return NewGenericOpenAPIError(error, body, nil)
}
...
// SetError sets the error message of the error object
...
// SetBody sets the body of the error object
...
// SetModel sets the model of the error object
