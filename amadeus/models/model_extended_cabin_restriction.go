...
var _ amadeus.MappedNullable = &ExtendedCabinRestriction{}
...
func (o *ExtendedCabinRestriction) GetOriginDestinationIds() []string {
	if o == nil || amadeus.IsNil(o.OriginDestinationIds) {
		var ret []string
		return ret
	}
...
func (o *ExtendedCabinRestriction) GetCoverage() Coverage {
	if o == nil || amadeus.IsNil(o.Coverage) {
		var ret Coverage
		return ret
	}
	return *o.Coverage
...
func (o ExtendedCabinRestriction) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.OriginDestinationIds) {
		toSerialize["originDestinationIds"] = o.OriginDestinationIds
	}
	if !amadeus.IsNil(o.Coverage) {
