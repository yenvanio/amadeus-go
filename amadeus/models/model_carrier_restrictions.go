...
var _ amadeus.MappedNullable = &CarrierRestrictions{}
...
func (o *CarrierRestrictions) GetBlacklistedInEUAllowed() bool {
	if o == nil || amadeus.IsNil(o.BlacklistedInEUAllowed) {
		var ret bool
		return ret
	}
...
func (o *CarrierRestrictions) GetExcludedCarrierCodes() []string {
	if o == nil || amadeus.IsNil(o.ExcludedCarrierCodes) {
		var ret []string
		return ret
	}
...
func (o *CarrierRestrictions) GetIncludedCarrierCodes() []string {
	if o == nil || amadeus.IsNil(o.IncludedCarrierCodes) {
		var ret []string
		return ret
	}
...
func (o CarrierRestrictions) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.BlacklistedInEUAllowed) {
		toSerialize["blacklistedInEUAllowed"] = o.BlacklistedInEUAllowed
	}
	if !amadeus.IsNil(o.ExcludedCarrierCodes) {
		toSerialize["excludedCarrierCodes"] = o.ExcludedCarrierCodes
	}
	if !amadeus.IsNil(o.IncludedCarrierCodes) {
