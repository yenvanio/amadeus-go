...
var _ amadeus.MappedNullable = &FlightStop{}
...
func (o *FlightStop) GetArrivalAt() time.Time {
	if o == nil || amadeus.IsNil(o.ArrivalAt) {
		var ret time.Time
		return ret
	}
	return *o.ArrivalAt
...
func (o *FlightStop) GetDepartureAt() time.Time {
	if o == nil || amadeus.IsNil(o.DepartureAt) {
		var ret time.Time
		return ret
	}
...
func (o FlightStop) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.ArrivalAt) {
		toSerialize["arrivalAt"] = o.ArrivalAt
	}
	if !amadeus.IsNil(o.DepartureAt) {
