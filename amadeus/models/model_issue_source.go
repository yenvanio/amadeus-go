...
var _ amadeus.MappedNullable = &IssueSource{}
...
func (o *IssueSource) GetPointer() string {
	if o == nil || amadeus.IsNil(o.Pointer) {
		var ret string
		return ret
	}
	return *o.Pointer
...
func (o *IssueSource) GetParameter() string {
	if o == nil || amadeus.IsNil(o.Parameter) {
		var ret string
		return ret
	}
	return *o.Parameter
...
func (o *IssueSource) GetExample() string {
	if o == nil || amadeus.IsNil(o.Example) {
		var ret string
		return ret
	}
	return *o.Example
...
func (o IssueSource) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.Pointer) {
		toSerialize["pointer"] = o.Pointer
	}
	if !amadeus.IsNil(o.Parameter) {
		toSerialize["parameter"] = o.Parameter
	}
	if !amadeus.IsNil(o.Example) {
