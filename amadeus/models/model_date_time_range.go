...
var _ amadeus.MappedNullable = &DateTimeRange{}
...
func (o *DateTimeRange) GetDateWindow() string {
	if o == nil || amadeus.IsNil(o.DateWindow) {
		var ret string
		return ret
	}
	return *o.DateWindow
...
func (o *DateTimeRange) GetTimeWindow() string {
	if o == nil || amadeus.IsNil(o.TimeWindow) {
		var ret string
		return ret
	}
	return *o.TimeWindow
...
func (o DateTimeRange) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.Time) {
		toSerialize["time"] = o.Time
	}
	if !amadeus.IsNil(o.DateWindow) {
		toSerialize["dateWindow"] = o.DateWindow
	}
	if !amadeus.IsNil(o.TimeWindow) {
