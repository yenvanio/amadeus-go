...
var _ amadeus.MappedNullable = &CollectionLinks{}
...
func (o *CollectionLinks) GetPrevious() string {
	if o == nil || amadeus.IsNil(o.Previous) {
		var ret string
		return ret
	}
	return *o.Previous
...
func (o *CollectionLinks) GetFirst() string {
	if o == nil || amadeus.IsNil(o.First) {
		var ret string
		return ret
	}
	return *o.First
...
func (o CollectionLinks) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.Self) {
		toSerialize["self"] = o.Self
	}
	if !amadeus.IsNil(o.Next) {
		toSerialize["next"] = o.Next
	}
	if !amadeus.IsNil(o.Previous) {
		toSerialize["previous"] = o.Previous
	}
	if !amadeus.IsNil(o.Last) {
		toSerialize["last"] = o.Last
	}
	if !amadeus.IsNil(o.First) {
		toSerialize["first"] = o.First
	}
	if !amadeus.IsNil(o.Up) {
		toSerialize["up"] = o.Up
	}
