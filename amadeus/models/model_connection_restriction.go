...
var _ amadeus.MappedNullable = &ConnectionRestriction{}
...
func (o *ConnectionRestriction) GetMaxNumberOfConnections() float32 {
	if o == nil || amadeus.IsNil(o.MaxNumberOfConnections) {
		var ret float32
		return ret
	}
...
func (o *ConnectionRestriction) GetNonStopPreferred() bool {
	if o == nil || amadeus.IsNil(o.NonStopPreferred) {
		var ret bool
		return ret
	}
...
func (o *ConnectionRestriction) GetNonStopPreferredWeight() float32 {
	if o == nil || amadeus.IsNil(o.NonStopPreferredWeight) {
		var ret float32
		return ret
	}
...
func (o *ConnectionRestriction) GetAirportChangeAllowed() bool {
	if o == nil || amadeus.IsNil(o.AirportChangeAllowed) {
		var ret bool
		return ret
	}
...
func (o *ConnectionRestriction) GetTechnicalStopsAllowed() bool {
	if o == nil || amadeus.IsNil(o.TechnicalStopsAllowed) {
		var ret bool
		return ret
	}
