...
var _ amadeus.MappedNullable = &Segment{}
...
func (o *Segment) GetNumberOfStops() int32 {
	if o == nil || amadeus.IsNil(o.NumberOfStops) {
		var ret int32
		return ret
	}
...
func (o *Segment) GetBlacklistedInEU() bool {
	if o == nil || amadeus.IsNil(o.BlacklistedInEU) {
		var ret bool
		return ret
	}
...
func (o *Segment) GetCo2Emissions() []Co2Emission {
	if o == nil || amadeus.IsNil(o.Co2Emissions) {
		var ret []Co2Emission
		return ret
	}
...
func (o Segment) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.NumberOfStops) {
		toSerialize["numberOfStops"] = o.NumberOfStops
	}
	if !amadeus.IsNil(o.BlacklistedInEU) {
		toSerialize["blacklistedInEU"] = o.BlacklistedInEU
	}
	if !amadeus.IsNil(o.Co2Emissions) {
