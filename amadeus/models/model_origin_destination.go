...
var _ amadeus.MappedNullable = &OriginDestination{}
...
func (o *OriginDestination) GetOriginRadius() float32 {
	if o == nil || amadeus.IsNil(o.OriginRadius) {
		var ret float32
		return ret
	}
...
func (o *OriginDestination) GetAlternativeOriginsCodes() []string {
	if o == nil || amadeus.IsNil(o.AlternativeOriginsCodes) {
		var ret []string
		return ret
	}
...
func (o *OriginDestination) GetDestinationRadius() float32 {
	if o == nil || amadeus.IsNil(o.DestinationRadius) {
		var ret float32
		return ret
	}
...
func (o *OriginDestination) GetAlternativeDestinationsCodes() []string {
	if o == nil || amadeus.IsNil(o.AlternativeDestinationsCodes) {
		var ret []string
		return ret
	}
...
func (o *OriginDestination) GetDepartureDateTimeRange() DateTimeRange {
	if o == nil || amadeus.IsNil(o.DepartureDateTimeRange) {
...
func (o *OriginDestination) GetArrivalDateTimeRange() DateTimeRange {
	if o == nil || amadeus.IsNil(o.ArrivalDateTimeRange) {
		var ret DateTimeRange
		return ret
	}
