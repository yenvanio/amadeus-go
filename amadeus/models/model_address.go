...
var _ amadeus.MappedNullable = &Address{}
...
func (o *Address) GetLines() []string {
	if o == nil || amadeus.IsNil(o.Lines) {
		var ret []string
		return ret
	}
	return o.Lines
...
func (o *Address) GetPostalCode() string {
	if o == nil || amadeus.IsNil(o.PostalCode) {
		var ret string
		return ret
	}
	return *o.PostalCode
...
func (o *Address) GetStateName() string {
	if o == nil || amadeus.IsNil(o.StateName) {
		var ret string
		return ret
	}
	return *o.StateName
...
func (o *Address) GetPostalBox() string {
	if o == nil || amadeus.IsNil(o.PostalBox) {
		var ret string
		return ret
	}
	return *o.PostalBox
...
func (o Address) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.Lines) {
		toSerialize["lines"] = o.Lines
	}
	if !amadeus.IsNil(o.PostalCode) {
	...
	if !amadeus.IsNil(o.StateName) {
		toSerialize["stateName"] = o.StateName
	}
	if !amadeus.IsNil(o.PostalBox) {
