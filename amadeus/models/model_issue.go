...
var _ amadeus.MappedNullable = &Issue{}
...
func (o *Issue) GetStatus() int32 {
	if o == nil || amadeus.IsNil(o.Status) {
		var ret int32
		return ret
	}
	return *o.Status
...
func (o *Issue) GetTitle() string {
	if o == nil || amadeus.IsNil(o.Title) {
		var ret string
		return ret
	}
	return *o.Title
...
func (o *Issue) GetDetail() string {
	if o == nil || amadeus.IsNil(o.Detail) {
		var ret string
		return ret
	}
	return *o.Detail
...
func (o Issue) ToMap() (map[string]interface{}, error) {
	...
	if !amadeus.IsNil(o.Status) {
		toSerialize["status"] = o.Status
	}
	if !amadeus.IsNil(o.Code) {
		toSerialize["code"] = o.Code
	}
	if !amadeus.IsNil(o.Title) {
		toSerialize["title"] = o.Title
	}
	if !amadeus.IsNil(o.Detail) {
