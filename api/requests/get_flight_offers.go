...
// the number of adult travelers (age 12 or older on date of departure).  The total number of seated travelers (adult and children) can not exceed 9.
...
// the number of child travelers (older than age 2 and younger than age 12 on date of departure) who will each have their own separate seat. If specified, this number should be greater than or equal to 0  The total number of seated travelers (adult and children) can not exceed 9.
...
*/
func (a *ShoppingAPIService) GetFlightOffers(ctx context.Context) ApiGetFlightOffersRequest {
	return ApiGetFlightOffersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return Success
func (a *ShoppingAPIService) GetFlightOffersExecute(r ApiGetFlightOffersRequest) (*models.Success, *http.Response, error) {
	var (
	...
	if err != nil {
		return localVarReturnValue, nil, &api.GenericOpenAPIError{error: err.Error()}
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		newErr := &api.GenericOpenAPIError{
			body:  localVarBody,
		...
		if localVarHTTPResponse.StatusCode == 400 {
			...
			if err != nil {
				...
				return localVarReturnValue, localVarHTTPResponse, newErr
					...
					newErr.error = api.formatErrorMessage(localVarHTTPResponse.Status, &v)
					newErr.model = v
			return localVarReturnValue, localVarHTTPResponse, newErr
		}
...
func (r ApiSearchFlightOffersRequest) Execute() (*models.Success1, *http.Response, error) {
...
*/
func (a *ShoppingAPIService) SearchFlightOffers(ctx context.Context) ApiSearchFlightOffersRequest {
	return ApiSearchFlightOffersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Success1
func (a *ShoppingAPIService) SearchFlightOffersExecute(r ApiSearchFlightOffersRequest) (*models.Success1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []api.formFile
		localVarReturnValue  *models.Success1
	)
