...
var _ api.MappedNullable = &CollectionMeta{}
...
func (o *CollectionMeta) GetOneWayCombinations() []OneWayCombinations {
	if o == nil || api.IsNil(o.OneWayCombinations) {
...
func (o CollectionMeta) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Count) {
		toSerialize["count"] = o.Count
	}
	if !api.IsNil(o.OneWayCombinations) {
