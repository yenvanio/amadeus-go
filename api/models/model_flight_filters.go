...
var _ api.MappedNullable = &FlightFilters{}
...
func (o *FlightFilters) GetCrossBorderAllowed() bool {
	if o == nil || api.IsNil(o.CrossBorderAllowed) {
		var ret bool
		return ret
	}
...
func (o *FlightFilters) GetMoreOvernightsAllowed() bool {
	if o == nil || api.IsNil(o.MoreOvernightsAllowed) {
		var ret bool
		return ret
	}
...
func (o *FlightFilters) GetReturnToDepartureAirport() bool {
	if o == nil || api.IsNil(o.ReturnToDepartureAirport) {
		var ret bool
		return ret
	}
...
func (o *FlightFilters) GetRailSegmentAllowed() bool {
	if o == nil || api.IsNil(o.RailSegmentAllowed) {
		var ret bool
		return ret
	}
...
func (o *FlightFilters) GetBusSegmentAllowed() bool {
	if o == nil || api.IsNil(o.BusSegmentAllowed) {
		var ret bool
		return ret
	}
...
func (o *FlightFilters) GetMaxFlightTime() float32 {
	if o == nil || api.IsNil(o.MaxFlightTime) {
		var ret float32
		return ret
	}
...
func (o *FlightFilters) GetCarrierRestrictions() CarrierRestrictions {
	if o == nil || api.IsNil(o.CarrierRestrictions) {
...
func (o *FlightFilters) GetCabinRestrictions() []ExtendedCabinRestriction {
	if o == nil || api.IsNil(o.CabinRestrictions) {
...
func (o *FlightFilters) GetConnectionRestriction() ConnectionRestriction {
	if o == nil || api.IsNil(o.ConnectionRestriction) {
