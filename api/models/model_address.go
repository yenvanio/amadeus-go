...
var _ api.MappedNullable = &Address{}
...
func (o *Address) GetPostalCode() string {
	if o == nil || api.IsNil(o.PostalCode) {
		var ret string
		return ret
	}
	return *o.PostalCode
...
func (o *Address) GetStateName() string {
	if o == nil || api.IsNil(o.StateName) {
		var ret string
		return ret
	}
	return *o.StateName
...
func (o *Address) GetPostalBox() string {
	if o == nil || api.IsNil(o.PostalBox) {
		var ret string
		return ret
	}
	return *o.PostalBox
...
func (o Address) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Lines) {
		toSerialize["lines"] = o.Lines
	}
	if !api.IsNil(o.PostalCode) {
	...
	if !api.IsNil(o.StateName) {
		toSerialize["stateName"] = o.StateName
	}
	if !api.IsNil(o.PostalBox) {
