...
var _ api.MappedNullable = &FlightOfferPricingIn{}
...
func (o *FlightOfferPricingIn) GetTravelers() []Traveler {
	if o == nil || api.IsNil(o.Travelers) {
		var ret []Traveler
		return ret
	}
	return o.Travelers
...
func (o FlightOfferPricingIn) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Payments) {
		toSerialize["payments"] = o.Payments
	}
	if !api.IsNil(o.Travelers) {
