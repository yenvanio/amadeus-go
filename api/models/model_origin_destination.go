...
var _ api.MappedNullable = &OriginDestination{}
...
func (o *OriginDestination) GetOriginLocationCode() string {
	if o == nil || api.IsNil(o.OriginLocationCode) {
		var ret string
		return ret
	}
...
func (o *OriginDestination) GetDestinationLocationCode() string {
	if o == nil || api.IsNil(o.DestinationLocationCode) {
		var ret string
		return ret
	}
...
func (o *OriginDestination) GetIncludedConnectionPoints() []string {
	if o == nil || api.IsNil(o.IncludedConnectionPoints) {
		var ret []string
		return ret
	}
...
func (o *OriginDestination) GetExcludedConnectionPoints() []string {
	if o == nil || api.IsNil(o.ExcludedConnectionPoints) {
		var ret []string
		return ret
	}
...
func (o *OriginDestination) GetOriginRadius() float32 {
	if o == nil || api.IsNil(o.OriginRadius) {
		var ret float32
		return ret
	}
...
func (o *OriginDestination) GetAlternativeOriginsCodes() []string {
	if o == nil || api.IsNil(o.AlternativeOriginsCodes) {
		var ret []string
		return ret
	}
...
func (o *OriginDestination) GetDestinationRadius() float32 {
	if o == nil || api.IsNil(o.DestinationRadius) {
		var ret float32
		return ret
	}
...
func (o *OriginDestination) GetAlternativeDestinationsCodes() []string {
	if o == nil || api.IsNil(o.AlternativeDestinationsCodes) {
		var ret []string
		return ret
	}
...
func (o *OriginDestination) GetDepartureDateTimeRange() DateTimeRange {
	if o == nil || api.IsNil(o.DepartureDateTimeRange) {
...
func (o *OriginDestination) GetArrivalDateTimeRange() DateTimeRange {
	if o == nil || api.IsNil(o.ArrivalDateTimeRange) {
		var ret DateTimeRange
		return ret
	}
