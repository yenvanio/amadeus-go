...
var _ api.MappedNullable = &Discount{}
...
func (o *Discount) GetTravelerType() DiscountTravelerType {
	if o == nil || api.IsNil(o.TravelerType) {
...
func (o *Discount) GetCardNumber() string {
	if o == nil || api.IsNil(o.CardNumber) {
		var ret string
		return ret
	}
	return *o.CardNumber
...
func (o *Discount) GetCertificateNumber() string {
	if o == nil || api.IsNil(o.CertificateNumber) {
		var ret string
		return ret
	}
...
func (o Discount) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.SubType) {
		toSerialize["subType"] = o.SubType
	}
	if !api.IsNil(o.CityName) {
		toSerialize["cityName"] = o.CityName
	}
	if !api.IsNil(o.TravelerType) {
		toSerialize["travelerType"] = o.TravelerType
	}
	if !api.IsNil(o.CardNumber) {
		toSerialize["cardNumber"] = o.CardNumber
	}
	if !api.IsNil(o.CertificateNumber) {
