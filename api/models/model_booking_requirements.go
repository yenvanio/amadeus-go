...
var _ api.MappedNullable = &BookingRequirements{}
...
func (o *BookingRequirements) GetInvoiceAddressRequired() bool {
	if o == nil || api.IsNil(o.InvoiceAddressRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetMailingAddressRequired() bool {
	if o == nil || api.IsNil(o.MailingAddressRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetEmailAddressRequired() bool {
	if o == nil || api.IsNil(o.EmailAddressRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetPhoneCountryCodeRequired() bool {
	if o == nil || api.IsNil(o.PhoneCountryCodeRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetMobilePhoneNumberRequired() bool {
	if o == nil || api.IsNil(o.MobilePhoneNumberRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetPhoneNumberRequired() bool {
	if o == nil || api.IsNil(o.PhoneNumberRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetPostalCodeRequired() bool {
	if o == nil || api.IsNil(o.PostalCodeRequired) {
		var ret bool
		return ret
	}
...
func (o *BookingRequirements) GetTravelerRequirements() []PassengerConditions {
	if o == nil || api.IsNil(o.TravelerRequirements) {
