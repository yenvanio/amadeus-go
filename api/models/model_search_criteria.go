...
var _ api.MappedNullable = &SearchCriteria{}
...
func (o *SearchCriteria) GetExcludeAllotments() bool {
	if o == nil || api.IsNil(o.ExcludeAllotments) {
		var ret bool
		return ret
	}
...
func (o *SearchCriteria) GetAddOneWayOffers() bool {
	if o == nil || api.IsNil(o.AddOneWayOffers) {
		var ret bool
		return ret
	}
...
func (o *SearchCriteria) GetMaxFlightOffers() float32 {
	if o == nil || api.IsNil(o.MaxFlightOffers) {
		var ret float32
		return ret
	}
...
func (o *SearchCriteria) GetAllowAlternativeFareOptions() bool {
	if o == nil || api.IsNil(o.AllowAlternativeFareOptions) {
		var ret bool
		return ret
	}
...
func (o *SearchCriteria) GetOneFlightOfferPerDay() bool {
	if o == nil || api.IsNil(o.OneFlightOfferPerDay) {
		var ret bool
		return ret
	}
...
func (o *SearchCriteria) GetAdditionalInformation() AdditionalInformation {
	if o == nil || api.IsNil(o.AdditionalInformation) {
...
func (o *SearchCriteria) GetFlightFilters() FlightFilters {
	if o == nil || api.IsNil(o.FlightFilters) {
