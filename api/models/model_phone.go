...
var _ api.MappedNullable = &Phone{}
...
func (o *Phone) GetDeviceType() PhoneDeviceType {
	if o == nil || api.IsNil(o.DeviceType) {
...
func (o *Phone) GetCountryCallingCode() string {
	if o == nil || api.IsNil(o.CountryCallingCode) {
		var ret string
		return ret
	}
...
func (o Phone) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.DeviceType) {
		toSerialize["deviceType"] = o.DeviceType
	}
	if !api.IsNil(o.CountryCallingCode) {
