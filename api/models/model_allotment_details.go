...
var _ api.MappedNullable = &AllotmentDetails{}
...
func (o *AllotmentDetails) GetTourReference() string {
	if o == nil || api.IsNil(o.TourReference) {
		var ret string
		return ret
	}
...
func (o AllotmentDetails) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.TourName) {
		toSerialize["tourName"] = o.TourName
	}
	if !api.IsNil(o.TourReference) {
