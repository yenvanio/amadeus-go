...
var _ api.MappedNullable = &Contact{}
...
func (o *Contact) GetCompanyName() string {
	if o == nil || api.IsNil(o.CompanyName) {
		var ret string
		return ret
	}
...
func (o *Contact) GetEmailAddress() string {
	if o == nil || api.IsNil(o.EmailAddress) {
		var ret string
		return ret
	}
...
func (o Contact) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Phones) {
		toSerialize["phones"] = o.Phones
	}
	if !api.IsNil(o.CompanyName) {
		toSerialize["companyName"] = o.CompanyName
	}
	if !api.IsNil(o.EmailAddress) {
