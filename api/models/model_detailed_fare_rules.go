...
var _ api.MappedNullable = &DetailedFareRules{}
...
func (o *DetailedFareRules) GetFareNotes() TermAndCondition {
	if o == nil || api.IsNil(o.FareNotes) {
...
func (o *DetailedFareRules) GetSegmentId() string {
	if o == nil || api.IsNil(o.SegmentId) {
		var ret string
		return ret
	}
	return *o.SegmentId
...
func (o DetailedFareRules) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.FareNotes) {
		toSerialize["fareNotes"] = o.FareNotes
	}
	if !api.IsNil(o.SegmentId) {
