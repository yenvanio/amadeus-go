...
var _ api.MappedNullable = &Dictionaries{}
...
func (o *Dictionaries) GetLocations() map[string]LocationValue {
	if o == nil || api.IsNil(o.Locations) {
...
func (o *Dictionaries) GetCurrencies() map[string]string {
	if o == nil || api.IsNil(o.Currencies) {
		var ret map[string]string
		return ret
	}
	return *o.Currencies
...
func (o Dictionaries) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Locations) {
		toSerialize["locations"] = o.Locations
	}
	if !api.IsNil(o.Aircraft) {
		toSerialize["aircraft"] = o.Aircraft
	}
	if !api.IsNil(o.Currencies) {
		toSerialize["currencies"] = o.Currencies
	}
	if !api.IsNil(o.Carriers) {
