...
var _ api.MappedNullable = &IdentityDocument{}
...
func (o *IdentityDocument) GetIssuanceDate() string {
	if o == nil || api.IsNil(o.IssuanceDate) {
		var ret string
		return ret
	}
...
func (o *IdentityDocument) GetExpiryDate() string {
	if o == nil || api.IsNil(o.ExpiryDate) {
		var ret string
		return ret
	}
	return *o.ExpiryDate
...
func (o *IdentityDocument) GetIssuanceCountry() string {
	if o == nil || api.IsNil(o.IssuanceCountry) {
		var ret string
		return ret
	}
...
func (o *IdentityDocument) GetIssuanceLocation() string {
	if o == nil || api.IsNil(o.IssuanceLocation) {
		var ret string
		return ret
	}
...
func (o *IdentityDocument) GetNationality() string {
	if o == nil || api.IsNil(o.Nationality) {
		var ret string
		return ret
	}
...
func (o *IdentityDocument) GetBirthPlace() string {
	if o == nil || api.IsNil(o.BirthPlace) {
		var ret string
		return ret
	}
	return *o.BirthPlace
...
func (o *IdentityDocument) GetDocumentType() DocumentType {
	if o == nil || api.IsNil(o.DocumentType) {
...
func (o *IdentityDocument) GetValidityCountry() string {
	if o == nil || api.IsNil(o.ValidityCountry) {
		var ret string
		return ret
	}
...
func (o *IdentityDocument) GetBirthCountry() string {
	if o == nil || api.IsNil(o.BirthCountry) {
		var ret string
		return ret
	}
