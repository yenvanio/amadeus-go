...
var _ api.MappedNullable = &TermAndCondition{}
...
func (o *TermAndCondition) GetCircumstances() string {
	if o == nil || api.IsNil(o.Circumstances) {
		var ret string
		return ret
	}
...
func (o *TermAndCondition) GetNotApplicable() bool {
	if o == nil || api.IsNil(o.NotApplicable) {
		var ret bool
		return ret
	}
...
func (o *TermAndCondition) GetMaxPenaltyAmount() string {
	if o == nil || api.IsNil(o.MaxPenaltyAmount) {
		var ret string
		return ret
	}
...
func (o *TermAndCondition) GetDescriptions() []Description {
	if o == nil || api.IsNil(o.Descriptions) {
		var ret []Description
		return ret
	}
...
func (o TermAndCondition) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Category) {
		toSerialize["category"] = o.Category
	}
	if !api.IsNil(o.Circumstances) {
		toSerialize["circumstances"] = o.Circumstances
	}
	if !api.IsNil(o.NotApplicable) {
		toSerialize["notApplicable"] = o.NotApplicable
	}
	if !api.IsNil(o.MaxPenaltyAmount) {
		toSerialize["maxPenaltyAmount"] = o.MaxPenaltyAmount
	}
	if !api.IsNil(o.Descriptions) {
