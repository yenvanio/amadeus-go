...
var _ api.MappedNullable = &ExtendedPrice{}
...
func (o *ExtendedPrice) GetRefundableTaxes() string {
	if o == nil || api.IsNil(o.RefundableTaxes) {
		var ret string
		return ret
	}
...
func (o *ExtendedPrice) GetGrandTotal() string {
	if o == nil || api.IsNil(o.GrandTotal) {
		var ret string
		return ret
	}
	return *o.GrandTotal
...
func (o *ExtendedPrice) GetBillingCurrency() string {
	if o == nil || api.IsNil(o.BillingCurrency) {
		var ret string
		return ret
	}
...
func (o ExtendedPrice) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.Currency) {
		toSerialize["currency"] = o.Currency
	}
	if !api.IsNil(o.Total) {
