...
var _ api.MappedNullable = &CarrierRestrictions{}
...
func (o *CarrierRestrictions) GetBlacklistedInEUAllowed() bool {
	if o == nil || api.IsNil(o.BlacklistedInEUAllowed) {
		var ret bool
		return ret
	}
...
func (o *CarrierRestrictions) GetExcludedCarrierCodes() []string {
	if o == nil || api.IsNil(o.ExcludedCarrierCodes) {
		var ret []string
		return ret
	}
...
func (o *CarrierRestrictions) GetIncludedCarrierCodes() []string {
	if o == nil || api.IsNil(o.IncludedCarrierCodes) {
		var ret []string
		return ret
	}
