...
var _ api.MappedNullable = &Traveler{}
...
func (o *Traveler) GetDateOfBirth() string {
	if o == nil || api.IsNil(o.DateOfBirth) {
		var ret string
		return ret
	}
...
func (o *Traveler) GetDocuments() []IdentityDocument {
	if o == nil || api.IsNil(o.Documents) {
...
func (o *Traveler) GetEmergencyContact() EmergencyContact {
	if o == nil || api.IsNil(o.EmergencyContact) {
...
func (o *Traveler) GetLoyaltyPrograms() []LoyaltyProgram {
	if o == nil || api.IsNil(o.LoyaltyPrograms) {
...
func (o *Traveler) GetDiscountEligibility() []Discount {
	if o == nil || api.IsNil(o.DiscountEligibility) {
		var ret []Discount
		return ret
	}
...
func (o Traveler) ToMap() (map[string]interface{}, error) {
	...
	if !api.IsNil(o.DateOfBirth) {
		toSerialize["dateOfBirth"] = o.DateOfBirth
	}
	if !api.IsNil(o.Gender) {
		toSerialize["gender"] = o.Gender
	}
	if !api.IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !api.IsNil(o.Documents) {
		toSerialize["documents"] = o.Documents
	}
	if !api.IsNil(o.EmergencyContact) {
		toSerialize["emergencyContact"] = o.EmergencyContact
	}
	if !api.IsNil(o.LoyaltyPrograms) {
		toSerialize["loyaltyPrograms"] = o.LoyaltyPrograms
	}
	if !api.IsNil(o.DiscountEligibility) {
		toSerialize["discountEligibility"] = o.DiscountEligibility
	}
	if !api.IsNil(o.Contact) {
