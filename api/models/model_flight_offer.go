...
var _ api.MappedNullable = &FlightOffer{}
...
func (o *FlightOffer) GetInstantTicketingRequired() bool {
	if o == nil || api.IsNil(o.InstantTicketingRequired) {
		var ret bool
		return ret
	}
...
func (o *FlightOffer) GetDisablePricing() bool {
	if o == nil || api.IsNil(o.DisablePricing) {
		var ret bool
		return ret
	}
...
func (o *FlightOffer) GetNonHomogeneous() bool {
	if o == nil || api.IsNil(o.NonHomogeneous) {
		var ret bool
		return ret
	}
...
func (o *FlightOffer) GetPaymentCardRequired() bool {
	if o == nil || api.IsNil(o.PaymentCardRequired) {
		var ret bool
		return ret
	}
...
func (o *FlightOffer) GetLastTicketingDate() string {
	if o == nil || api.IsNil(o.LastTicketingDate) {
		var ret string
		return ret
	}
...
func (o *FlightOffer) GetLastTicketingDateTime() time.Time {
	if o == nil || api.IsNil(o.LastTicketingDateTime) {
		var ret time.Time
		return ret
	}
...
func (o *FlightOffer) GetNumberOfBookableSeats() float32 {
	if o == nil || api.IsNil(o.NumberOfBookableSeats) {
		var ret float32
		return ret
	}
...
func (o *FlightOffer) GetItineraries() []Itineraries {
	if o == nil || api.IsNil(o.Itineraries) {
		var ret []Itineraries
		return ret
	}
...
func (o *FlightOffer) GetPricingOptions() PricingOptions {
	if o == nil || api.IsNil(o.PricingOptions) {
...
func (o *FlightOffer) GetValidatingAirlineCodes() []string {
	if o == nil || api.IsNil(o.ValidatingAirlineCodes) {
		var ret []string
		return ret
	}
...
func (o *FlightOffer) GetTravelerPricings() []TravelerPricing {
	if o == nil || api.IsNil(o.TravelerPricings) {
